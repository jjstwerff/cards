...
public class Player {
	...
	public class IndexMember extends RedBlackTree implements Iterable<Member>, Iterator<Member> {
		...
		protected int readTop() {
			return store.getInt(store.getInt(record.getRec(), 27), 44);
		}

		@Override
		protected void changeTop(int value) {
			store.setInt(store.getInt(record.getRec(), 27), 44, value);
		}
	...
	public class IndexPlayerName extends RedBlackTree implements Iterable<Player>, Iterator<Player> {
		...
		@Override
		protected int readTop() {
			return store.getInt(0, 48);
		}

		@Override
		protected void changeTop(int value) {
			store.setInt(0, 48, value);
		}
